...
namespace SubmissionAndIntake.Contracts.ServiceContracts
{
    public interface ISubmissionService
    {
        ...
        Task<IEnumerable<SubmissionResponseDto>> GetSubmissionsByAgentIdAsync(Guid agentId);
        Task<IEnumerable<SubmissionResponseDto>> GetSubmissionsByPartyIdAsync(Guid partyId);
